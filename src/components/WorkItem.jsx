...
function WorkItem({ year, title, duration, details }) {
  return (
    <ol className="flex flex-col md:flex-row border-l border-stone-200">
      <li className="relative mb-10 ml-4">
        <div className="absolute w-3 h-3 bg-stone-200 rounded-full mt-1.5 -left-[1.4rem] border-white" />
